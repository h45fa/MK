...
export function setMovements(fighter1, fighter2, pressed) {
	const fighter1NextMoveType = getMoveFromCombination(
		fighter1,
		KEYS[0],
		pressed
	)
	fighter1.setMove(fighter1NextMoveType)
	const fighter2NextMoveType = getMoveFromCombination(
		fighter2,
		KEYS[1],
		pressed
	)
...
function getMoveFromCombination(fighter, keys, pressed) {
	if (pressed[keys.HK] && fighter.moveType === MOVE_TYPES.FORWARD_JUMP)
		return MOVE_TYPES.FORWARD_JUMP_KICK
	if (pressed[keys.LK] && fighter.moveType === MOVE_TYPES.FORWARD_JUMP)
		return MOVE_TYPES.FORWARD_JUMP_KICK
	if (pressed[keys.HK] && fighter.moveType === MOVE_TYPES.BACKWARD_JUMP)
		return MOVE_TYPES.BACKWARD_JUMP_KICK
	if (pressed[keys.LK] && fighter.moveType === MOVE_TYPES.BACKWARD_JUMP)
		return MOVE_TYPES.BACKWARD_JUMP_KICK
	if (pressed[keys.HP] && fighter.moveType === MOVE_TYPES.FORWARD_JUMP)
		return MOVE_TYPES.FORWARD_JUMP_PUNCH
	if (pressed[keys.LP] && fighter.moveType === MOVE_TYPES.FORWARD_JUMP)
		return MOVE_TYPES.FORWARD_JUMP_PUNCH
	if (pressed[keys.HP] && fighter.moveType === MOVE_TYPES.BACKWARD_JUMP)
		return MOVE_TYPES.BACKWARD_JUMP_PUNCH
	if (pressed[keys.LP] && fighter.moveType === MOVE_TYPES.BACKWARD_JUMP)
		return MOVE_TYPES.BACKWARD_JUMP_PUNCH
	...
	if (fighter.moveType === MOVE_TYPES.SQUAT && !pressed[keys.DOWN])
		return MOVE_TYPES.STAND_UP
